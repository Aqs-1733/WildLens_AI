...
const labels: Record<string,string> = { mammal:'哺乳动物', bird:'鸟类', plant:'植物', insect:'昆虫', reptile:'爬行动物', unknown:'待确认' }
...
export default function DashboardPage() {
 ...
 const distribution=useMemo(()=>data?.category_distribution.map(i=>({name:labels[i.name]||i.name,value:i.value}))||[],[data])
